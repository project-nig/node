...
mp_request_step2_done.step1("mp_request_step2_done","{daniel_owner.public_key_hash}","{daniel_owner.public_key_hex}",{transaction_amount_eur2},"{smart_contract_account}","False",1,1)
