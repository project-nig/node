...
class Node:
    ...
    def send_new_block_PoH_registry_input_data(self, block: dict) -> requests.Response:
        return self.post(endpoint="block_PoH_registry_input_data", data=block)
    
    def send_new_block_PoH_registry_intermediary(self, block: dict) -> requests.Response:
        return self.post(endpoint="block_PoH_registry_intermediary", data=block)
